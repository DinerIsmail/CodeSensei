...
namespace CodeSensei.Controllers
{
    public class AccountController : Controller
    {
        ...
        {
            if (!_aggregator.UserRepository.List().Any(x => x.Email == email && x.Password == password))
        ...
        public HttpStatusCodeResult Register(User user)
        {
            ...
            _aggregator.UserRepository.Save(user);
